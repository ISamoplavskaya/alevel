...
public class Triangle extends Figure {
    ...
    public double perimeter() {
        if (sideA != 0 && sideB != 0 && sideC != 0) {
            ...
            System.out.println("There is not enough data to calculate the perimeter of a triangle");
            return 0;
        }
    ...
    public double area() {
        if (sideA != 0 && sideB != 0 && sideC != 0) {
            ...
            System.out.println("There is not enough data to calculate the area of a triangle");
            return 0;
        }
    }
